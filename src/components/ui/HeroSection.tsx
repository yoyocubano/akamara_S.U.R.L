      ...
      <div className="container relative z-10 px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          >
            <Link 
              to="/catalogo" 
              className="w-full sm:w-auto group relative px-8 py-4 bg-amber-500 text-slate-950 font-black rounded-full overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(245,158,11,0.4)]"
            >
            ...
            <Link 
              to="/contact" 
              className="w-full sm:w-auto px-8 py-4 bg-white/5 border border-white/10 text-white font-bold rounded-full backdrop-blur-md hover:bg-white/10 transition-all flex items-center justify-center space-x-2"
            >
              <Shield size={18} />
